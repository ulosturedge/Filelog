...
var generateHere4 = document.getElementById("user_link");
generateHere4.innerHTML = '<i class="fa fa-table"></i> My Table ('+obj.user+')';
}
});
               ...
               <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <li><a class="ajax-link" id="user_link" href="<?php echo base_url(); ?>public/judicial/user/<?php echo $_SESSION['uid'];?>"><i class="fa fa-table"></i> My Table </a>
                    </li>
